// Code originally sourced from https://codepen.io/h1p3/pen/jbWNVR on 11/19/20
   ...
   */
    ...
    function __onScrubberTouch() {
      ...
      function __findMovingTileFromScrubber() {
        ...
        do {
          if ( current.hasClass( 'draggableTile' ) ) {
            var found = current;
            break;
          }
        ...
        if ( found ) {
          ...
          ok = error( "parent tile of scrubber not found (no \"draggableTile\" class)" );
        }
      }
